/**
  ...
  * @@tag Forrester@vle.forrester @@namespace:IbminsideGVLE;class:Y;421|400;c:X,57,147,90,25|masse,59,220,90,25|maturing,321,214,90,25|;f:Growth,214,174,56,20,KG * X * masse,false,,,|Senescence,210,271,79,20,masse * KS *  ( 1 - maturing ) ,true,maturing == 0,masse * KS,0|;fa:X,Growth,5,2|Growth,masse,3,5|masse,Senescence,3,0|;p:KG,355,87,30,16|KS,334,326,30,16|;pa:KS,Senescence,3,5,304,308|X,Growth,5,0,194,160|masse,Senescence,3,2,168,256|maturing,Senescence,4,4,305,249|masse,Growth,1,2,170,197|KG,Growth,3,0,291,123|;ev:;v:;@@end tag@@
  */
